...
[![PyPi](https://img.shields.io/pypi/v/spans_and_trees.svg)](https://pypi.org/project/spans-and-trees/) [![License](https://img.shields.io/pypi/l/spans_and_trees.svg)](https://www.tldrlegal.com/license/mit-license) [![Tests](https://github.com/jakelever/spans_and_trees/actions/workflows/tests.yml/badge.svg)](https://github.com/jakelever/spans_and_trees/actions) [![codecov](https://codecov.io/gh/jakelever/spans_and_trees/branch/main/graph/badge.svg)](https://codecov.io/gh/jakelever/spans_and_trees)
...
The format of the spans is a `Span`, a namedtuple of length 4 (importable from `spans_and_trees`). The element contents are:

1. `start` - The start location of the span
2. `length` - The length of the span
